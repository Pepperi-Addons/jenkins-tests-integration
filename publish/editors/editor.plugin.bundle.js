(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('@angular/core'), require('pepperi-user-service'), require('@angular/common'), require('@angular/material'), require('@angular/forms')) :
    typeof define === 'function' && define.amd ? define(['exports', '@angular/core', 'pepperi-user-service', '@angular/common', '@angular/material', '@angular/forms'], factory) :
    (global = global || self, factory(global.scheduler = {}, global.core, global.pepperiUserService, global.common, global.material, global.forms));
}(this, (function (exports, core, pepperiUserService, common, material, forms) { 'use strict';
    ...
    * ```
    ...
    let AddonApiService = class AddonApiService {
        constructor(userService, httpClient) {
            ...
            this.papiBaseURL = '';
            this.addonData = {};
            const parsedToken = lib(this.userService.getUserToken());
            this.papiBaseURL = parsedToken['pepperi.baseurl'];
        }
        getAddonApiBaseURL() {
            return  `${this.papiBaseURL}/addons/api/async/${this.addonData.Addon.UUID}`; //async added
        }
    ...
    AddonApiService = __decorate([
        core.Injectable(),
        __metadata("design:paramtypes", [typeof (_a = typeof pepperiUserService.UserService !== "undefined" && pepperiUserService.UserService) === "function" ? _a : Object, HttpClient])
    ], AddonApiService);

    let PluginComponent = class PluginComponent {
        constructor(translate, addonApiService) {
            this.translate = translate;
            this.addonApiService = addonApiService;
    ...
    let ApiTesterComponent = class ApiTesterComponent {
        ...
        testEndpoint(endpoint, successFunc = null, errorFunc = null) {
            const self = this;
            this.backendApiService.getApiEndpoint(endpoint).subscribe((res) => {
                if (successFunc) {
                    successFunc(res);
                }
                else {
        ...
        getExecutionLog(executionUUID, successFunc, errorFunc = null) {
            ...
            this.backendApiService.get(url).subscribe(res => {
                if (successFunc) {
                    successFunc(res);
                }
            }, (error) => {
        ...
        pollExecution(endpoint, pollingInterval = 30000, stopConditionFunction = (res) => { return res.length > 0 && (res[0].Status.Name === 'Failure' || res[0].Status.Name === 'Success'); }) {
            this.testEndpoint(endpoint, jobRes => {
                let self = this;
                const interval = window.setInterval(() => {
                    this.getExecutionLog(jobRes.ExecutionUUID, logRes => {
